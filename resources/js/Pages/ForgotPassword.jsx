            ...
            <section id="forgot-password">
                <div className="container">
                    ...
                    <p className="subtitle">
                        {successSent ? "If the email exists, we sent a link. Check your email for a link to reset your password. If you don't see it, please check your spam folder." : "Enter your user account's verified email address and we will send you a password reset link."}
                    </p>
